...
function app (opts) {
  return new Promise(function (resolve, reject) {
    ...
    // comment next line to get raw data
      ...
      .then(R.assoc('country', opts.country))
...
const MAPPINGS = {
  ...
  similarAppsUrl1:{
      path: ['ds:6', 1, 1, 0, 21, 1],
      fun: (val) => {
          if (val == null) return null;

          if(val[0] == "Similar apps" || val[0] == "Similar games" || val[0] == "More apps to try") {
            return "https://play.google.com" + val[2][4][2];
          }
